...
export const getBookmarks = () => (dispatch) => axios.get("/api/bookmarks/data").then((response) => {
  dispatch({
    type: "GET_BOOKMARKS",
...
export const updateBookmarked = (id) => (dispatch) => axios.post("/api/bookmarks/update", { id }).then(() => {
